...
const EditPatient = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axiosInstance.put(`/api/patient/update/${patientId}`, data, {
        headers: {
      ...
      navigate('/admin/patient/list'); // Redirect to doctor list after successful update
    } catch (error) {
  ...
  return (
    <div>
      <h1 className="font-serif text-2xl text-center font-bold py-5">Update Patient</h1>
